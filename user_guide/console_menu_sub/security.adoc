...
Clicking *[Security]* -> *[Pod Security Policies]* from the console menus displays the main screen of *Pod Security Policies*. +
...
Clicking *[Security]* -> *[Network Policies]* from the console menus displays the main screen of *Network Policies*. +
