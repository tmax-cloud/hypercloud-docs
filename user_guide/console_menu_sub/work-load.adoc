...
|CONCURRENT EXECUTION동시 실행 정책|Allow or not simultaneous execution of jobs to be executed by cron jobs.
* Allow: Allow simultaneous execution
* Forbid: Not allow simultaneous execution
|마감 초 시작하기|The number of seconds to retry if the job fails to execute on the specified schedule
|====================