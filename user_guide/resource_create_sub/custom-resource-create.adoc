...
. <<.../console_menu_sub/management#img-custom-resource-main,사용자 리소스 정의 메인 화면>>의 네임스페이스 선택 영역에서 새로운 CRD를 생성할 네임스페이스를 선택한 후 *[사용자 리소스 정의 생성]* 버튼을 클릭한다. (QA: 네임스페이스 선택하지 않음)
