...
----
* Parameters From +
하위 세부 항목은 xref:../form-set-item.adoc#<Parameters From>["폼 에디터 설정 항목 참조"의 "Parameters From"]을 참고한다.
* secretName
* Secret Transforms +
하위 세부 항목은 xref:../form-set-item.adoc#<Secret Transforms>["폼 에디터 설정 항목 참조"의 "Secret Transforms"]를 참고한다.
