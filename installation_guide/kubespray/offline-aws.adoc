...
.사용 방법
----
$ ansible-playbook -i .inventory/tmaxcloud/hosts ./cluster.yml -e ansible_user=centos -e ansible_ssh_private_key_file={PEM_PATH} -e cloud_provider=aws -b --become-user=root --flush-cache -v
----
...
*k8s 리소스 삭제*
----
$ ansible-playbook -i ./inventory/tmaxcloud/hosts ./reset.yml -e ansible_user=centos -e ansible_ssh_private_key_file={PEM_PATH} -e cloud_provider=aws -b --become-user=root --flush-cache -v
----
