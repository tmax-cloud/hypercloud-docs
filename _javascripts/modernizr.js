			...
			function e(e, o) {
				...
				return (
					i ||
						...
						o.setAttribute &&
							o.removeAttribute &&
							(o.setAttribute(e, ''), (i = a(o[e], 'function')), a(o[e], 'undefined') || (o[e] = n), o.removeAttribute(e))),
					(o = null),
					i
				);
			}
	...
	return (
		...
		(function (e, t) {
			...
			function a(e, n, r) {
				...
				var a;
				return (
					(a = r.cache[e] ? r.cache[e].cloneNode() : p.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e)),
