...
* adoc을 작성하면서 {product-title}, {product-version}으로 xref:../_distro_map.adoc[_distro_map.yml]_distro_map.yml의 변수를 참조할 수 있습니다. xref:product-name--version[참고]
...
* xref:../_distro_map.adoc[_distro_map.yml] 파일에 등록한 특정 distro에서만 보여질 컨텐츠는 
