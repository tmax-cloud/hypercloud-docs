...
. *사용자 기본 정보 설정* +
*Add user* 화면에서 생성할 사용자의 기본 정보를 설정한 후 *[Save]* 버튼을 클릭한다.
+
...
여러 사용자가 동일한 계정으로 로그인할 수 있다. 

image::../../images/figure_hyperauth_duplicate_login.png[]

<1> *[Events]* 메뉴 선택
<2> *[Config]* 탭 선택
<3> *[Evnet Listeneres]*에서 *"duplicate_login_block"*을 해제
